                        ...
                        <form @submit.prevent="submit">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    >
                                    <span class="text-xs" v-if="form.errors.first_name">{{ form.errors.first_name }}</span>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    >
                                    <span class="text-xs" v-if="form.errors.last_name">{{ form.errors.last_name }}</span>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    >
                                    <span class="text-xs" v-if="form.errors.email">{{ form.errors.email }}</span>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    >
                                    <span class="text-xs" v-if="form.errors.position">{{ form.errors.position }}</span>
                                </div>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <span class="text-xs" v-if="form.errors.account_id">{{ form.errors.account_id }}</span>
                                </div>
                            </div>
