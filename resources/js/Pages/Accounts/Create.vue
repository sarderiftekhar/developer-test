                        ...
                        <form @submit.prevent="submit">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    >
                                    <span class="text-xs" v-if="form.errors.name">{{ form.errors.name }}</span>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <span class="text-xs" v-if="form.errors.owner_id">{{ form.errors.owner_id }}</span>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    >
                                    <span class="text-xs" v-if="form.errors.phone">{{ form.errors.phone }}</span>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    >
                                    <span class="text-xs" v-if="form.errors.country">{{ form.errors.country }}</span>
                                </div>
                                ...
                                <div class="col-span-6">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    >
                                    <span class="text-xs" v-if="form.errors.address">{{ form.errors.address }}</span>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    >
                                    <span class="text-xs" v-if="form.errors.town_city">{{ form.errors.town_city }}</span>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                    ...
                                    <input
                                        ...
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    >
                                    <span class="text-xs" v-if="form.errors.post_code">{{ form.errors.post_code }}</span>
                                </div>
                            </div>
